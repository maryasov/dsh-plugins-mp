					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [item.source === "npm" && item.updateAvailable === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									style: S.installBtn,
									disabled: busy,
									onClick: () => act("/plugins/dsh-plugins-mp/update", { name: item.name }),
									children: t.update
								}) : null, confirming ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									style: {
										...S.installBtn,
										...BADGE_TONE.failed
		...
		function MarketShell(props) {
			...
			const body = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					tab === "mine" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(InstalledView, {}) : null,
